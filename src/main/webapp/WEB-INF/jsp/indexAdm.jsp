              ...
              <div class="card-body p-4">
                ...
                <ul class="timeline-widget mb-0 position-relative mb-n5">
                  <li class="timeline-item d-flex position-relative overflow-hidden">
                    ...
                    <div class="timeline-desc fs-3 text-dark mt-n1"> Gamma Airline</div>
                  </li>
                  <li class="timeline-item d-flex position-relative overflow-hidden">
                  ...
                  <li class="timeline-item d-flex position-relative overflow-hidden">
                    ...
                    <div class="timeline-desc fs-3 text-dark mt-n1 fw-semibold">Alpha Airline<a
                        href="javascript:void(0)" class="text-primary d-block fw-normal">#ML-3467</a>
                    </div>
                  </li>
                  <li class="timeline-item d-flex position-relative overflow-hidden">
                    ...
                    <div class="timeline-desc fs-3 text-dark mt-n1 fw-semibold">Omega Airline</div>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              ...
              <div class="card-body pt-3 p-4">
                <h6 class="fw-semibold fs-4">Omega Airline</h6>
                <div class="d-flex align-items-center justify-content-between">
                  <h6 class="fw-semibold fs-4 mb-0"><i class="ti ti-currency-rupee fs-6"></i>4,000 <span class="ms-2 fw-normal text-muted fs-3"><del>5,500</del></span></h6>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              <div class="position-relative">
                ...
                <a href="javascript:void(0)" class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i class="ti ti-basket fs-4"></i></a>                      </div>
              <div class="card-body pt-3 p-4">
                <h6 class="fw-semibold fs-4">Gamma Airline</h6>
                <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              <div class="position-relative">
                ...
                <a href="javascript:void(0)" class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i class="ti ti-basket fs-4"></i></a>                      </div>
              <div class="card-body pt-3 p-4">
                <h6 class="fw-semibold fs-4">Beta Airline</h6>
                <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              <div class="position-relative">
                ...
                <a href="javascript:void(0)" class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i class="ti ti-basket fs-4"></i></a>                      </div>
              <div class="card-body pt-3 p-4">
                <h6 class="fw-semibold fs-4">Alpha Airline</h6>
                <div class="d-flex align-items-center justify-content-between">
