                ...
                <div class="card-body p-4">
                  <div class="container">
                    ...
                    <form action="/searchFlight" method="post">
                        <div class="mb-3">
                            <label for="sourceAirport" class="form-label"><i class="ti ti-plane-departure"></i> Source Airport</label>
                            <select id="sourceAirport" name="sourceAirport" class="form-control" required>
                                <c:forEach var="airport" items="${airports}">
                                    <option class="form-control" value="${airport.airportLocation}">${airport.airportLocation}</option>
                                </c:forEach>
                            </select>
                          </div>
                          <div class="mb-3">
                            <label for="destinationAirport" class="form-label"><i class="ti ti-plane-arrival"></i> Destination Airport</label>
