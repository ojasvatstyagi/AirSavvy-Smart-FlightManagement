...
<div class="container section">
  ...
  <div class="mb-5 text-center">
    <h2>Contact</h2>
    <div class="d-flex flex-column flex-md-row justify-content-center align-items-start gap-4 mt-4">
      <!-- Address details -->
      <div class="contact-info text-md-start" style="min-width: 280px; max-width: 350px;">
        <p><i class="ti ti-current-location"></i>Bengaluru, INDIA</p>
        <p><i class="ti ti-phone"></i>+00 1010101010</p>
        <p><i class="ti ti-mail"></i>myemail@something.com</p>
      </div>

      <!-- Contact form -->
      <form action="/about" method="post" style="max-width: 480px; width: 100%;">
        <div class="mb-3">
