                ...
                <div class="card-body p-4">
                  <div class="container" >
                    ...
                    <form action="/route" method="post">
                      ...
                      <div class="mb-3">
                        <label for="sourceAirportCode" class="form-label">Select Source Airport Code</label>
                        <select id="sourceAirportCode" name="sourceAirportCode" class="form-control" required>
                            <c:forEach var="airport" items="${codeList}">
                                <option class="form-control" value="${airport.airportCode}">${airport.airportCode}</option>
                            </c:forEach>
                        </select>
                      </div>
                      <div class="mb-3">
                        <label for="destinationAirportCode" class="form-label">Select Destination Airport Code</label>
                      ...
                      <div class="mb-3">
                        <label for="price" class="form-label">Fair Of This Route</label>
                        <input type="text" class="form-control" id="price" name="price" placeholder="xxxx" required>
                      </div>
