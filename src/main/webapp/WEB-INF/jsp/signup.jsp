                  ...
                  >
                    ...
                    <div class="mb-4 password-wrapper">
                      ...
                      <input
                        ...
                        aria-describedby="toggleConfirmPasswordLabel"
                      />
                      <button
                        type="button"
                        class="toggle-password"
                    ...
                    >
                      ...
                      <a class="text-primary fw-bold ms-2" href="/loginpage"
                        >Sign In</a
                      >
                    </div>
                  </form>
    ...
    <script>
      function validateForm() {
        ...
        if (!regex.test(password)) {
          alert(
            "Password must contain at least one number, lowercase letter, and one special character."
          );
          return false;
        }
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        toggleConfirmPassword.addEventListener("click", function () {
          ...
          iconConfirmPassword.classList.toggle("bi-eye");
          iconConfirmPassword.classList.toggle("bi-eye-slash");
        });
      });
    </script>
